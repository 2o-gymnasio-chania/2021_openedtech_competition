...
<img src="photos/feedBot_1.JPG" width=50%>

**Φωτογραφία 3** *Το πρωτότυπο ρομπότ FeedBot, σχεδιασμέον και κατασκευασμένο από την ομάδα ROBOTEAM του 2ου Γυμνασίου Χανίων.*
