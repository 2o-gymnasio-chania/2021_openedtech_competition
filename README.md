...
<img src="photos/kataskeyes/synarmologisi.jpg" width=80%>
...
![αλγόριθμος που υλοποιεί την παροχή τροφής](schediasi/logismiko/trofi.png)

*Aλγόριθμος που υλοποιεί την παροχή τροφής*

![αλγόριθμος που υλοποιεί την παροχή νερού](schediasi/logismiko/nero.png) *

*Aλγόριθμος που υλοποιεί την παροχή νερού*

## Υλοποίηση της ιδέας ##

<img src="photos/works_1.jpg" width=50%>

*Στιγμιότυπο από τις εργασίες της ομάδας*
