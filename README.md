...
<img src="photos/feedBot_1.JPG" width=30%>

**Φωτογραφία 3** *Το πρωτότυπο ρομπότ FeedBot, σχεδιασμέο και κατασκευασμένο από την ομάδα ROBOTEAM του 2ου Γυμνασίου Χανίων*
